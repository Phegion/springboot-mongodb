...
import com.phegion.workshopmongo.dto.AuthorDTO;
import com.phegion.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		CommentDTO c1 = new CommentDTO("Boa viajem bro", sdf.parse("21/03/2020"), new AuthorDTO(alex));
